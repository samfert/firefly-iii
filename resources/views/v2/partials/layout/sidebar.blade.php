<aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark" role="navigation" aria-label="{{ __('firefly.main_navigation') }}">
    <!--begin::Sidebar Brand-->
    <div class="sidebar-brand">
        <!--begin::Brand Link-->
        <a href="{{route('index') }}" class="brand-link">
            <!--begin::Brand Image-->
            <img src="images/logo.png" alt="{{ __('firefly.firefly_iii_logo') }}"
